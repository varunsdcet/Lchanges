...
export default class ApprovalDetail extends Component {
    ...
    loadHome(selectes)
    {
        ...
        if (GLOBAL.whichApproval == "1"){

            var url = GLOBAL.BASE_URL + 'approved_attendance_list';
            axios.post(url, {
                user_id: GLOBAL.userID,
                from:GLOBAL.approvalArray.from,
                to :GLOBAL.approvalArray.to,
            ...
            if (GLOBAL.approvalArray.type == "1") {


                var url = GLOBAL.BASE_URL + 'attendance_details';
                axios.post(url, {
                    user_id: GLOBAL.userID,
    ...
    _handlePress() {
        ...
        ac =   ac.slice(0, -1);
        GLOBAL.aid = ac
        this.props.navigation.replace('AttendanceVideo')
    }
...
//            alert(acronym)
        ...
        return (
            ...
            <View style = {{margin:10,borderRadius:16,backgroundColor:'white'}}>
                ...
                <Text style = {{fontSize : 18,color :'#77869E', height:'auto',fontFamily:'AvenirLTStd-Medium',marginLeft:4,marginBottom:3}}>
                    {stringsoflanguages.total}  {item.total_labour}
                        ...
                        <View style = {{flexDirection:  'row',marginTop:20,width:'100%'}}>
                            ...
                            <View style = {{width:'90%',flexDirection:'row'}}>
                                ...
                                <Text style = {{marginLeft: 12,width:200,color:'#042C5C',fontSize: 22,fontFamily:'AvenirLTStd-Heavy',}}>
                                    {stringsoflanguages.approvalDetail}
                        ...
                        <View style = {{margin:10,marginTop:8,borderRadius:16,backgroundColor:'white'}}>
                            ...
                            <View style = {{backgroundColor:"#f7fbfc",borderRadius:4,height:40,margin:10}}>
                                ...
                                <Text style = {{color:"#042C5C",fontSize : 18, height:'auto',fontFamily:'AvenirLTStd-Medium',marginLeft:'5%',marginTop:12}}>
                                    {stringsoflanguages.attendanceAppr}
                                </Text>
